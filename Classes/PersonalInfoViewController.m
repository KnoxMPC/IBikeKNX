...
//        _alertViewController = [UIAlertController alertControllerWithTitle:@"Choose One" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
...
//        [_alertViewController.view addSubview:doneToolbar];
        
        _actionPicker = [[ActionSheetStringPicker alloc] init];
        selectedItem = 0;
        NSArray *selectedArray;
        if(myTextField == gender){
            selectedItem = [user.gender integerValue];
            selectedArray = genderArray;
        }
        ...
        [ActionSheetStringPicker showPickerWithTitle:@"Choose One"
                                    ...
                                    initialSelection:selectedItem
                                           doneBlock:^(ActionSheetStringPicker *picker,
                                               ...
                                               myTextField.text = [selectedArray objectAtIndex:selectedIndex];
                                               if(myTextField == gender){
                                                   ...
                                                   riderHistorySelectedRow = selectedIndex;
                                               }
                                           }
                                         cancelBlock:nil
                                              origin:self.view];
...
//        
//        [_alertViewController.view setBounds:CGRectMake(0, 0, 320, 485)];
//        [_alertViewController.view addSubview:pickerView];
